...
object nth {
  // Tail recursion through the list
  ...
  val list = new Cons(1, new Cons(2, new Cons(3, new Nil)))
                                                  //> list  : week4.Cons[Int] = week4.Cons@58ecb281
  
  nth(2, list)                                    //> res0: Int = 3
  nth(-1, list)                                   //> java.lang.IndexOutOfBoundsException
                                                  //| 	at week4.nth$$anonfun$main$1.nth$1(week4.nth.scala:9)
                                                  ...
                                                  //| 	at week4.nth$.main(week4.nth.scala:6)
